...
const SavedShows = () => {
  ...
  return (
    ...
    <div>
            <h2 className='text-white md:text-xl p-9 font-bold'>My Shows</h2>
      <div className='relative flex items-center group'>
        ...
        <div id={'slider'} className='w-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative'>
            {movies.map((item, id) => (
                <div key={id} className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] cursor-pointer inline-block relative p-2'>
